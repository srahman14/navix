...
const NavigationSidebar = () => {
  ...
  return (
    <div className="w-full md:w-96 bg-white dark:bg-zinc-900 border-r border-zinc-200 dark:border-zinc-800 flex flex-col overflow-hidden">
      {/* Header */}
      <div className="flex justify-between items-center padding-4 p-6 border-b border-zinc-200 dark:border-zinc-800">
        <div>
