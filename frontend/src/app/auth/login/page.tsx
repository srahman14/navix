      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-neutral-500 dark:text-neutral-400">
            Sign in to access route optimization
          </p>
        </div>
        ...
        <div className="bg-neutral-50 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-lg p-6">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              >
                <span className="text-neutral-400 dark:text-neutral-600">01</span> Email
              </label>
              <input
                id="email"
                type="email"
            ...
            <div className="space-y-2">
              <label 
                ...
                className="block text-xs font-mono uppercase tracking-wider text-neutral-500 dark:text-neutral-400"
              >
                <span className="text-neutral-400 dark:text-neutral-600">02</span> Password
              </label>
              <input
                id="password"
                type="password"
            ...
            <div className="flex items-center justify-between pt-2">
              <label className="flex items-center gap-2 cursor-pointer">
                <input 
                  type="checkbox" 
                  className="w-4 h-4 rounded border-neutral-300 dark:border-neutral-700 bg-white dark:bg-neutral-950 text-neutral-900 dark:text-neutral-100 focus:ring-neutral-900 dark:focus:ring-neutral-100 focus:ring-offset-2"
                />
